...
<section class="intro">
  ...
  <p>ما محصولات را با کیفیت بالا و بهترین کلیپ های آموزشی را دراختیار شما گذاشته ایم تاشما به سادگی بتوانید پرندگان خود را پرورش بدهید.</p>
</section>
<section class="products">
  <h3>محصولات پر فروش</h3>
  <div class="product-list">
    <a href="Products.php" class="product-card">
